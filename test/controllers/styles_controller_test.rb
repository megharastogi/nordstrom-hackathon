...
class StylesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post styles_url, params: { style: { brandName: @style.brandName, imageURL: @style.imageURL, name: @style.name, shopper_id: @style.shopper_id, styleID: @style.styleID } }
    end
  ...
  test "should update style" do
    patch style_url(@style), params: { style: { brandName: @style.brandName, imageURL: @style.imageURL, name: @style.name, shopper_id: @style.shopper_id, styleID: @style.styleID } }
